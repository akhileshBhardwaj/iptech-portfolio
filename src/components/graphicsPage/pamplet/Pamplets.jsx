...
import PampletsCard from "./PampletsCard";
import pampletsData from "./pampletsData";
...
const Pamplets = () => {
  return (
    <section
      id="pamplets-showcase"
      aria-labelledby="pamplets-showcase-heading"
