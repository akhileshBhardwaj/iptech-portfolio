    ...
    <div className="relative w-full bg-transparent px-6 py-16 md:py-24">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 lg:grid-cols-[40%_60%]">
        ...
        <div>
          ...
          >
            We create eye-catching graphics that turn ideas into powerful
            visuals. From social media designs and promotional creatives to
            brand visuals, every design is crafted to capture attention and
